...
import { Component, EntryKind, SetComponent } from "../types/config";
...
const SetForm = ({
  ...
  return (
    <div className="border-solid border-black border-2 rounded-lg shadow-lg m-3 p-3 bg-lime-200">
      <Accordion
        open={getValueByPointer(state.model, `${prefix}/open`)}
        setOpen={(value) => actions.onChange(`${prefix}/open`, value)}
        summary={<>{getValueByPointer(state.model, `${prefix}/label`)}</>}
      ...
      >
        ...
        <Button onClick={() => actions.addTimer(`${prefix}/components/-`)}>
